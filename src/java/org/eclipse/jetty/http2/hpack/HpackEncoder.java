...
public class HpackEncoder {
    ...
    public void encode(ByteBuffer buffer, MetaData metadata) {
        // jet: wraps in a try-catch block to wrap any thrown exception into an IllegalStateException (a
        // RuntimeException) for backwards compatibility with signature of method.
        try {
            ...
            if (fields != null) {
                ...
                for (HttpField field : fields) {
                    ...
                    String name = Utils.getLowerCaseFieldName(field);
